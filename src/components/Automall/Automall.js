...
class Automall extends React.Component {
    constructor(props){
     ...
     this.state={
        ...
        //     { id: 9, Brand: 'Lexus',  model: 'RX', img: '/assets/lexus/rx.png', price: 25000, description: 'универсал', slogan: '235-HP* 2.0L TURBO' },
        //     { id: 10, Brand: 'Lexus', model: 'RXh',img: '/assets/lexus/rxh.png', price: 15000, description: ' ceдан', slogan: '235-HP* 2.0L TURBO'  },
        //     { id: 11, Brand: 'Lexus', model: 'GX', img: '/assets/lexus/gx.png', price: 20000, description: 'кроссовер', slogan: '235-HP* 2.0L TURBO'  },
        //     { id: 12, Brand: 'Lexus', model: 'LX',img: '/assets/lexus/lx.png', price: 35000, description: 'универсал', slogan: '235-HP* 2.0L TURBO'  },
        //     { id: 13, Brand: 'Lexus', model: 'ES', img: '/assets/lexus/es.png', price: 30000, description: 'седан', slogan: '235-HP* 2.0L TURBO'  },
        //     { id: 14, Brand: 'Lexus', model: 'ES', img: '/assets/lexus/esh.png', price: 18000, description: 'кроссовер', slogan: '235-HP* 2.0L TURBO'  },
        //     { id: 15, Brand: 'Lexus', model: 'NX', img: '/assets/lexus/nx.png', price: 25000, description: 'седан', slogan: '235-HP* 2.0L TURBO'  },
        //     { id: 16, Brand: 'Lexus', model: 'NXh', img: '/assets/lexus/nxh.png', price: 20000, description: 'седан', slogan: '235-HP* 2.0L TURBO'  },
       
        //      { id: 17, Brand: 'KIA', model: 'K5', img: '/assets/kia/k5.png', price: 25000, description: 'универсал' },
        //      { id: 18, Brand: 'KIA', model: 'Sorento', img: '/assets/kia/rio.png', price: 15000, description: ' ceдан' },
        //      { id: 19, Brand: 'KIA', model: 'Sportage', img: '/assets/kia/sorento.png', price: 20000, description: 'кроссовер' },
        //      { id: 20, Brand: 'KIA', model: 'Seltos', img: '/assets/kia/seltos.png', price: 35000, description: 'универсал' },
        //      { id: 21, Brand: 'KIA', model: 'Telluride', img: '/assets/kia/sportage.png', price: 30000, description: 'седан' },
        //      { id: 22, Brand: 'KIA', model: 'Soul', img: '/assets/kia/soul.png', price: 18000, description: 'кроссовер' },
        //      { id: 23, Brand: 'KIA', model: 'RIO', img: '/assets/kia/riox.png', price: 25000, description: 'седан' },
        //      { id: 24, Brand: 'KIA', model: 'K5', img: '/assets/kia/careta.png', price: 20000, description: 'седан' },
      
        //      { id: 25, Brand: 'Toyota', model: 'Toyota Camry', img: '/assets/toyota/corolla.png', price: 'от 2 909 000 с', description: '2.5л', year: 2021 },
        //      { id: 26, Brand: 'Toyota', model: 'Toyota Corolla', img: '/assets/toyota/camry.png', price: 'от 2 519 000 с', description: '1.6л', year: 2021 },
        //      { id: 27, Brand: 'Toyota', model: 'Toyota RAV4', img: '/assets/toyota/rav4.png', price: 'от 3 147 000 с', description: '2.0л', year: 2021 },
        //      { id: 28, Brand: 'Toyota', model: 'Toyota CH-R', img: '/assets/toyota/c-hr.png', price: 'от 3 147 000 с', description: '2.0л', year: 2021 },
        //      { id: 29, Brand: 'Toyota', model: 'Toyota Prado', img: '/assets/toyota/prado.png', price: 'от 4 843 000 с', description: '2.7л', year: 2021 },
        //      { id: 30, Brand: 'Toyota', model: 'Toyota Highlander', img: '/assets/toyota/hillux.png', price: 'от 4 843 000 с', description: '2.7л', year: 2021 },
