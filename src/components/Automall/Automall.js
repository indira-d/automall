    ...
    constructor(props){
     ...
     this.state={
        ...
        carCatalogue: [
            ...
            { id: 9, Brand: 'Lexus', model: 'RX', img: '/assets/lexus/rx.png', price: 25000, description: 'универсал', slogan: 'ВАШ КАЧЕСТВЕННО НОВЫЙ МИР' },
            { id: 10, Brand: 'Lexus', model: 'RXh',img: '/assets/lexus/rxh.png', price: 15000, description: ' ceдан' },
            { id: 11, Brand: 'Lexus', model: 'GX', img: '/assets/lexus/gx.png', price: 20000, description: 'кроссовер' },
            { id: 12, Brand: 'Lexus', model: 'LX',img: '/assets/lexus/lx.png', price: 35000, description: 'универсал' },
            { id: 13, Brand: 'Lexus',model: 'ES', img: '/assets/lexus/es.png', price: 30000, description: 'седан' },
            { id: 14, Brand: 'Lexus', model: 'ES', img: '/assets/lexus/esh.png', price: 18000, description: 'кроссовер' },
            { id: 15, Brand: 'Lexus', model: 'NX', img: '/assets/lexus/nx.png', price: 25000, description: 'седан' },
            { id: 16, Brand: 'Lexus', model: 'NXh', img: '/assets/lexus/nxh.png', price: 20000, description: 'седан' },
