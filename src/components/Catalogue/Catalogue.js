        ...
        return (
            <div className='catalogueWrapper'>
                ...
                <div className='catalogueMenu'>
                    ...
                    <button className={this.state.showChevrolet ? 'active' : 'cItem'} onClick={() => this.setState({showIsuzu: false, showBMW: false, showLexus: false, showKIA: false, showToyota: false, showChevrolet: true,showGas: false, showJac: false, activeModel: 'СHEVROLET'})}>Chevrolet</button>
